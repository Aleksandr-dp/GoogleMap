/* Создайте веб-приложение - Карта с маркерами:

- 4 поля ввода (Широта, Долгота, имя метки, описание метки)
- Кнопка "добавить", очищающая поля и добавляющая метку на карту
- перевод имени метки в транслит */
